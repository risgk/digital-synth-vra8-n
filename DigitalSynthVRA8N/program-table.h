...
const uint8_t g_preset_table_OSC1_2_WAVE  [] = {0  , 0  , 0  , 127, 0  , 0  , 48 , 0  };
...
const uint8_t g_preset_table_OSC2_FINE    [] = {68 , 72 , 66 , 72 , 68 , 48 , 68 , 64 };
...
const uint8_t g_preset_table_FILTER_CUTOFF[] = {64 , 16 , 16 , 112, 112, 100, 64 , 127};
const uint8_t g_preset_table_FILTER_RESO  [] = {96 , 80 , 127, 0  , 0  , 64 , 64 , 0  };
...
const uint8_t g_preset_table_EG_DECAY     [] = {64 , 96 , 96 , 96 , 0  , 32 , 64 , 0  };
const uint8_t g_preset_table_EG_SUSTAIN   [] = {127, 0  , 0  , 0  , 127, 96 , 0  , 127};
...
const uint8_t g_preset_table_EG_TO_LFO_R  [] = {64 , 64 , 64 , 72 , 64 , 64 , 64 , 64 };
const uint8_t g_preset_table_LFO_TO_P_TGT [] = {127, 0  , 0  , 0  , 0  , 0  , 0  , 0  };
const uint8_t g_preset_table_LFO_FADE_TIME[] = {64 , 64 , 0  , 0  , 0  , 64 , 0  , 0  };

const uint8_t g_preset_table_P_BEND_RANGE [] = {2  , 2  , 2  , 2  , 12 , 2  , 12 , 2  };
const uint8_t g_preset_table_P_TO_CUTOFF  [] = {0  , 0  , 0  , 0  , 0  , 127, 127, 0  };
const uint8_t g_preset_table_EXP_TO_CUTOFF[] = {64 , 64 , 64 , 64 , 64 , 112, 64 , 64 };
const uint8_t g_preset_table_EXP_TO_AMP_L [] = {0  , 0  , 0  , 0  , 0  , 127, 127, 0  };

const uint8_t g_preset_table_PORTAMENTO   [] = {0  , 32 , 32 , 0  , 0  , 0  , 0  , 0  };
const uint8_t g_preset_table_LEGATO       [] = {0  , 127, 127, 0  , 0  , 127, 0  , 0  };
const uint8_t g_preset_table_KEY_ASSIGN   [] = {0  , 64 , 0  , 127, 0  , 127, 127, 0  };
const uint8_t g_preset_table_EXP_BY_VEL   [] = {0  , 0  , 0  , 0  , 0  , 0  , 127, 0  };

const uint8_t g_preset_table_OSC_LEVEL    [] = {80 , 80 , 80 , 80 , 80 , 107, 80 , 80 };
...
const uint8_t g_preset_table_DAMP_AND_ATK [] = {0  , 0  , 0  , 0  , 0  , 64 , 0  , 0  };
...
const uint8_t g_preset_table_OSC1_2_WAVE  [] = {0  , 0  , 0  , 0  , 127, 0  , 0  , 48 };
...
const uint8_t g_preset_table_OSC2_FINE    [] = {68 , 68 , 72 , 66 , 72 , 68 , 48 , 68 };
...
const uint8_t g_preset_table_FILTER_CUTOFF[] = {64 , 64 , 16 , 16 , 112, 112, 100, 64 };
const uint8_t g_preset_table_FILTER_RESO  [] = {64 , 96 , 80 , 127, 0  , 0  , 64 , 64 };
...
const uint8_t g_preset_table_EG_DECAY     [] = {64 , 64 , 96 , 96 , 96 , 0  , 32 , 64 };
const uint8_t g_preset_table_EG_SUSTAIN   [] = {127, 127, 0  , 0  , 0  , 127, 96 , 0  };
...
const uint8_t g_preset_table_EG_TO_LFO_R  [] = {64 , 64 , 64 , 64 , 72 , 64 , 64 , 64 };
const uint8_t g_preset_table_LFO_TO_P_TGT [] = {0  , 127, 0  , 0  , 0  , 0  , 0  , 0  };
const uint8_t g_preset_table_LFO_FADE_TIME[] = {0  , 64 , 64 , 0  , 0  , 0  , 64 , 0  };

const uint8_t g_preset_table_P_BEND_RANGE [] = {30 , 2  , 2  , 2  , 2  , 12 , 2  , 12 };
const uint8_t g_preset_table_P_TO_CUTOFF  [] = {0  , 0  , 0  , 0  , 0  , 0  , 127, 127};
const uint8_t g_preset_table_EXP_TO_CUTOFF[] = {64 , 64 , 64 , 64 , 64 , 64 , 112, 64 };
const uint8_t g_preset_table_EXP_TO_AMP_L [] = {0  , 0  , 0  , 0  , 0  , 0  , 127, 127};

const uint8_t g_preset_table_PORTAMENTO   [] = {0  , 0  , 32 , 32 , 0  , 0  , 0  , 0  };
const uint8_t g_preset_table_LEGATO       [] = {0  , 0  , 127, 127, 0  , 0  , 127, 0  };
const uint8_t g_preset_table_KEY_ASSIGN   [] = {127, 0  , 64 , 0  , 127, 0  , 127, 127};
const uint8_t g_preset_table_EXP_BY_VEL   [] = {0  , 0  , 0  , 0  , 0  , 0  , 0  , 127};

const uint8_t g_preset_table_OSC_LEVEL    [] = {80 , 80 , 80 , 80 , 80 , 80 , 107, 80 };
const uint8_t g_preset_table_RESO_LIMIT   [] = {127, 127, 127, 127, 127, 127, 96 , 127};
const uint8_t g_preset_table_AMP_LEVEL    [] = {127, 127, 127, 127, 127, 127, 127, 127};
const uint8_t g_preset_table_DAMP_AND_ATK [] = {0  , 0  , 0  , 0  , 0  , 0  , 64 , 0  };
