...
const uint8_t g_preset_table_SUB_OSC_WAVE   [] = {127, 0  , 0  , 0  , 64 , 127, 0  , 0  };
const uint8_t g_preset_table_SUB_OSC_LEVEL  [] = {127, 127, 127, 0  , 8  , 0  , 0  , 0  };
...
const uint8_t g_preset_table_FILTER_CUTOFF  [] = {64 , 16 , 16 , 112, 0  , 100, 64 , 127};
...
const uint8_t g_preset_table_EG_ATTACK      [] = {0  , 0  , 0  , 0  , 32 , 16 , 0  , 0  };
const uint8_t g_preset_table_EG_DECAY       [] = {64 , 96 , 96 , 96 , 32 , 32 , 64 , 0  };
...
const uint8_t g_preset_table_P_TO_CUTOFF    [] = {0  , 0  , 0  , 0  , 127, 127, 127, 0  };
const uint8_t g_preset_table_EXP_TO_CUTOFF  [] = {64 , 64 , 64 , 64 , 88 , 112, 64 , 64 };
const uint8_t g_preset_table_EXP_TO_AMP_L   [] = {0  , 0  , 0  , 0  , 127, 127, 127, 0  };
...
const uint8_t g_preset_table_RESO_LIMIT     [] = {127, 127, 127, 127, 96 , 96 , 127, 127};
const uint8_t g_preset_table_AMP_LEVEL      [] = {127, 127, 127, 127, 127, 127, 127, 127};
const uint8_t g_preset_table_DAMP_AND_ATK   [] = {0  , 0  , 0  , 0  , 64 , 64 , 0  , 0  };
...
const uint8_t g_preset_table_SUB_OSC_WAVE   [] = {0  , 127, 0  , 0  , 0  , 64 , 127, 0  };
const uint8_t g_preset_table_SUB_OSC_LEVEL  [] = {127, 127, 127, 127, 0  , 8  , 0  , 0  };
...
const uint8_t g_preset_table_FILTER_CUTOFF  [] = {64 , 64 , 16 , 16 , 112, 0  , 100, 64 };
...
const uint8_t g_preset_table_EG_ATTACK      [] = {0  , 0  , 0  , 0  , 0  , 32 , 16 , 0  };
const uint8_t g_preset_table_EG_DECAY       [] = {64 , 64 , 96 , 96 , 96 , 32 , 32 , 64 };
...
const uint8_t g_preset_table_P_TO_CUTOFF    [] = {0  , 0  , 0  , 0  , 0  , 127, 127, 127};
const uint8_t g_preset_table_EXP_TO_CUTOFF  [] = {64 , 64 , 64 , 64 , 64 , 88 , 112, 64 };
const uint8_t g_preset_table_EXP_TO_AMP_L   [] = {0  , 0  , 0  , 0  , 0  , 127, 127, 127};
...
const uint8_t g_preset_table_RESO_LIMIT     [] = {127, 127, 127, 127, 127, 96 , 96 , 127};
const uint8_t g_preset_table_AMP_LEVEL      [] = {127, 127, 127, 127, 127, 127, 127, 127};
const uint8_t g_preset_table_DAMP_AND_ATK   [] = {0  , 0  , 0  , 0  , 0  , 64 , 64 , 0  };
