...
const uint8_t preset_table_OSC2_MIX     [] = {64 , 64 , 64 , 64 , 0  , 64 , 0  , 0  };
const uint8_t preset_table_OSC2_COARSE  [] = {71 , 64 , 64 , 64 , 64 , 64 , 64 , 64 };
const uint8_t preset_table_OSC2_FINE    [] = {68 , 72 , 66 , 72 , 68 , 68 , 64 , 64 };
...
const uint8_t preset_table_EG_DECAY     [] = {64 , 96 , 96 , 96 , 0  , 32 , 0  , 0  };
const uint8_t preset_table_EG_SUSTAIN   [] = {127, 0  , 0  , 0  , 127, 0  , 127, 127};
const uint8_t preset_table_EG_RELEASE   [] = {127, 127, 127, 127, 127, 0  , 127, 127};

const uint8_t preset_table_LFO_WAVE     [] = {0  , 0  , 0  , 127, 0  , 32 , 0  , 0  };
const uint8_t preset_table_LFO_RATE     [] = {64 , 64 , 64 , 80 , 64 , 64 , 64 , 64 };
const uint8_t preset_table_PITCH_LFO_AMT[] = {65 , 65 , 64 , 88 , 65 , 65 , 64 , 64 };
const uint8_t preset_table_CO_LFO_AMT   [] = {64 , 64 , 52 , 64 , 64 , 64 , 64 , 64 };

const uint8_t preset_table_LFO_DEPTH    [] = {16 , 16 , 0  , 0  , 0  , 16 , 0  , 0  };
const uint8_t preset_table_LFO_RT_EG_AMT[] = {64 , 64 , 64 , 72 , 64 , 64 , 64 , 64 };
const uint8_t preset_table_PITCH_LFO_TGT[] = {127, 0  , 0  , 0  , 0  , 0  , 0  , 0  };
...
const uint8_t preset_table_CO_EXP_AMT   [] = {0  , 0  , 0  , 0  , 0  , 64 , 0  , 0  };
const uint8_t preset_table_AMP_EXP_AMT  [] = {127, 127, 127, 127, 127, 127, 127, 127};

const uint8_t preset_table_PORTAMENTO   [] = {0  , 32 , 32 , 0  , 0  , 32 , 0  , 0  };
const uint8_t preset_table_LEGATO       [] = {0  , 127, 127, 0  , 0  , 127, 0  , 0  };
const uint8_t preset_table_KEY_ASSIGN   [] = {0  , 64 , 0  , 127, 0  , 127, 0  , 0  };
