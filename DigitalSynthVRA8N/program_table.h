...
const uint8_t g_preset_table_OSC2_FINE    [] = {68 , 72 , 66 , 72 , 68 , 68 , 64 , 64 };
...
const uint8_t g_preset_table_FILTER_CUTOFF[] = {76 , 28 , 0  , 127, 127, 112, 127, 127};
...
const uint8_t g_preset_table_AMP_EG_ON    [] = {127, 0  , 127, 0  , 127, 0  , 127, 127};

const uint8_t g_preset_table_EG_ATTACK    [] = {0  , 0  , 0  , 0  , 0  , 0  , 0  , 0  };
const uint8_t g_preset_table_EG_DECAY     [] = {64 , 96 , 96 , 96 , 0  , 32 , 0  , 0  };
const uint8_t g_preset_table_EG_SUSTAIN   [] = {127, 0  , 0  , 0  , 127, 0  , 127, 127};
...
const uint8_t g_preset_table_CO_EXP_AMT   [] = {0  , 0  , 0  , 0  , 0  , 64 , 0  , 0  };
