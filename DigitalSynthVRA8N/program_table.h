...
const uint8_t preset_table_FILTER_CUTOFF[] = {80 , 64 , 0  , 127, 127, 127, 127, 127};
const uint8_t preset_table_FILTER_RESO  [] = {80 , 64 , 127, 0  , 0  , 0  , 0  , 0  };
const uint8_t preset_table_CUTOFF_EG_AMT[] = {80 , 96 , 96,  64 , 64 , 64 , 64 , 64 };
const uint8_t preset_table_EG_DECAY     [] = {64 , 127, 96 , 0  , 0  , 0  , 0  , 0  };
...
const uint8_t preset_table_PORTAMENTO   [] = {32 , 32 , 32 , 32 , 0  , 0  , 0  , 0  };
const uint8_t preset_table_EG_ATTACK    [] = {0  , 32 , 0  , 0  , 0  , 0  , 0  , 0  };
...
const uint8_t preset_table_PITCH_LFO_AMT[] = {62 , 66 , 64 , 66 , 64 , 64 , 64 , 64 };
const uint8_t preset_table_CO_LFO_AMT   [] = {64 , 76 , 52 , 64 , 64 , 64 , 64 , 64 };
