...
const uint8_t preset_table_PITCH_EG_TGT [] = {0  , 127, 0  , 0  , 0  , 0  , 0  , 0  };

const uint8_t preset_table_FILTER_CUTOFF[] = {76 , 28 , 0  , 127, 127, 127, 127, 127};
...
const uint8_t preset_table_EG_DECAY     [] = {64 , 96 , 96 , 96 , 0  , 0  , 0  , 0  };
const uint8_t preset_table_EG_SUSTAIN   [] = {127, 0  , 0  , 0  , 127, 127, 127, 127};
const uint8_t preset_table_EG_RELEASE   [] = {127, 127, 127, 127, 127, 127, 127, 127};

const uint8_t preset_table_LFO_WAVE     [] = {0  , 0  , 0  , 127, 0  , 0  , 0  , 0  };
const uint8_t preset_table_LFO_RATE     [] = {64 , 64 , 64 , 80 , 64 , 64 , 64 , 64 };
const uint8_t preset_table_PITCH_LFO_AMT[] = {65 , 65 , 64 , 88 , 65 , 64 , 64 , 64 };
...
const uint8_t preset_table_PORTAMENTO   [] = {0  , 32 , 32 , 0  , 0  , 0  , 0  , 0  };
const uint8_t preset_table_LEGATO       [] = {0  , 127, 127, 0  , 0  , 0  , 0  , 0  };
const uint8_t preset_table_KEY_ASSIGN   [] = {0  , 64 , 0  , 127, 0  , 0  , 0  , 0  };
